...
const badges: AuthorBadgesResponse = {
  ...
  hyperliquid: {
    ...
    positions: [
      { coin: "ETH", side: "short", size: 13_980.58, entryPx: 2299.4, markPx: 2462.4, liquidationPx: 4320.47, unrealizedPnlUsd: -2_278_791, leverage: 25, valueUsd: 34_425_803 },
      { coin: "BTC", side: "long", size: 31.65, entryPx: 76_727.4, markPx: 76_651.9, liquidationPx: null, unrealizedPnlUsd: -2420, leverage: 30, valueUsd: 2_426_250 },
    ],
