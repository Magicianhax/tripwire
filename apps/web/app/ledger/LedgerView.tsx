...
/** The backend's whole call record. Self-hosted it is the user's own; hosted it is the operator's. */
export function LedgerView({ s, replay }: { s: LedgerSummary; replay: boolean }) {
  const emptyText = replay ? "Replay mode serves recorded data, so no Nansen calls are logged." : "No calls yet.";
