...
describe("product release configuration", () => {
  ...
  it("links to packaged releases rather than pretending to download source code", () => {
    expect(repositoryLinks("https://github.com/example/tripwire/")).toEqual({repository:"https://github.com/example/tripwire",release:"https://github.com/example/tripwire/releases/latest",download:"https://github.com/example/tripwire/releases/latest/download/tripwire-extension.zip"});
  });
