...
The detail behind the README: what each surface does, how verdicts are computed, every venue,
caching and credits, development, troubleshooting, and security.
...
- **Product page:** `/` renders the public product page (hero, the rotating screenshots above,
  ...
  needed or used. See [`docs/public-site-deployment.md`](public-site-deployment.md).
