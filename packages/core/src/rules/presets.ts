...
export const PRESETS: Record<PresetName, Rule[]> = {
  degen: [
    r("spot-exit", "spot", "exit_pressure", "<", -500_000, "block", "smart money, whales & public figures dump more than ${n}"),
    r("spot-fresh", "spot", "fresh_buy_share", ">", 90, "warn", "fresh wallets are more than {n}% of buying"),
    r("spot-sm24", "spot", "sm_netflow_24h", "<", -250_000, "warn", "Smart Money 24h net outflow exceeds ${n}"),
    r("spot-risk", "spot", "risk_high_count", ">=", 3, "block", "{n}+ Nansen risk indicators are high"),
  ...
  balanced: [
    r("spot-exit", "spot", "exit_pressure", "<", -100_000, "block", "smart money, whales & public figures dump more than ${n}"),
    r("spot-fresh", "spot", "fresh_buy_share", ">", 70, "warn", "fresh wallets are more than {n}% of buying"),
    r("spot-sm24", "spot", "sm_netflow_24h", "<", -50_000, "warn", "Smart Money 24h net outflow exceeds ${n}"),
    r("spot-risk", "spot", "risk_high_count", ">=", 2, "block", "{n}+ Nansen risk indicators are high"),
  ...
  paranoid: [
    r("spot-exit", "spot", "exit_pressure", "<", -25_000, "block", "smart money, whales & public figures dump more than ${n}"),
    r("spot-fresh", "spot", "fresh_buy_share", ">", 50, "block", "fresh wallets are more than {n}% of buying"),
    r("spot-sm24", "spot", "sm_netflow_24h", "<", 0, "block", "Smart Money 24h net outflow exceeds ${n}"),
    r("spot-risk", "spot", "risk_high_count", ">=", 1, "block", "{n}+ Nansen risk indicators are high"),
